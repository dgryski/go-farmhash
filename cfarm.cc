...
uint32_t cHash32WithSeed(const char *s, size_t len, uint32_t seed) { return util::Hash32WithSeed(s, len, seed); }
uint64_t cHash64WithSeed(const char *s, size_t len, uint64_t seed) { return util::Hash64WithSeed(s, len, seed); }
uint64_t cHash64WithSeeds(const char *s, size_t len, uint64_t seed0, uint64_t seed1) { return util::Hash64WithSeeds(s, len, seed0, seed1); }

void cHash128WithSeed(const char *s, size_t len, uint64_t seed0, uint64_t seed1, uint64_t *lo, uint64_t *hi) {
